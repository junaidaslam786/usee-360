  ...
  return (
    ...
    >
      ...
      <h4 style={{display: 'flex', justifyContent: 'center'}}>
        <i className="fa-solid fa-triangle-exclamation" style={{color: 'red', paddingRight: '5px'}}></i> {"  "} Alert{"  "}
        <i className="fa-solid fa-triangle-exclamation" style={{color: 'red', paddingLeft: '5px'}}></i>
      </h4>
