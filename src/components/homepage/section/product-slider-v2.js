...
class ProductSliderV2 extends Component {
  render() {
    ...
    return (
      <div
        className="ltn__search-by-place-area pt-115 pb-70"
            ...
            <div className="col-lg-4">
              <div className="ltn__search-by-place-item">
                ...
                <div className="search-by-place-info">
                  ...
                  <h4>
                    <Link to="/property-grid">Mission District Area</Link>
                  </h4>
            ...
            <div className="col-lg-4">
              <div className="ltn__search-by-place-item">
                ...
                <div className="search-by-place-info">
                  ...
                  <h4>
                    <Link to="/property-grid">Pacific Heights Area</Link>
                  </h4>
                  <div className="search-by-place-btn">
                    <Link to="/property-grid">
                      View Properties
            ...
            <div className="col-lg-4">
              <div className="ltn__search-by-place-item">
                ...
                <div className="search-by-place-info">
                  ...
                  <h4>
                    <Link to="/property-grid">Noe Valley Zones</Link>
                  </h4>
                  <div className="search-by-place-btn">
                    <Link to="/property-grid">
                      View Properties
