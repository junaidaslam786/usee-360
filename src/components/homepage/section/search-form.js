...
//     defaultPriceType ? defaultPriceType : null
//   );
...
//                                   setAddress(place.formatted_address); // Use the name of the place
//                                 } else {
//                                   console.error(
...
export default function SearchForm({
  ...
  const handlePriceTypeChange = (selectedOption) => {
    setPriceType(selectedOption);
    handleFiltersChange({ priceType: selectedOption.value });
  };
  ...
  useEffect(() => {
    ...
    if (inputElement && inputElement instanceof HTMLInputElement) {
      ...
      const handlePlaceSelect = () => {
        ...
        setLat(location.lat);
        setLng(location.lng);
        setAddress(place.name); // Use the name of the place
      };
