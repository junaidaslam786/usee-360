              ...
              <li>
                ...
                <ul>
                  <li>
                    ...
                    conditions (“<strong>terms</strong>”) set out the terms on
                    which we provide access to our U-See mobile application (“
                    <strong>our app</strong>”) and our website &nbsp;
                    <a href="https://usee360.com/">https://usee360.com/</a>{" "}
                    &nbsp; (the term “<strong>our site</strong>” refers to the
                    website and our app) which you use or through which you
                    access our services.
                  </li>
                  <li>
                    <strong>Why you should read them</strong>. Please read these
                    terms carefully before you use our site or our services.
                    These terms tell you who we are, and other important
                  ...
                  <li>
                    ...
                    . Our Privacy Policy and our Cookie Policy also apply to
                    your use of our site and our use of your personal
                    information. Our Privacy Policy and Cookie Policy are
                    incorporated into these terms.
                  </li>
                  <li>
                    <strong>We may make changes to these terms.</strong> We
                    amend these terms from time to time. Every time you wish to
                  ...
                  <li>
                    <strong>We may suspend or withdraw our site.</strong> Our
                    site is made available free of charge. We do not guarantee
                    that our site, or any content on it, will always be
              ...
              <li>
                ...
                <ul>
                  <li>
                    ...
                    link between you, potential buyers and those you represent
                    to engage in online visual real-time property viewings.
                  </li>
                  <li>
                    <strong>
                    ...
                    You acknowledge that the legal contract for supply and
                    purchase of the properties which are viewed is between you
                    and the buyer and seller and we are only supplying our
                    service to assist you with that process.
                  </li>
                </ul>
              </li>
              <li>
                ...
                <ul>
                  <li>
                    ...
                    your properties to be viewed through our site, you will need
                    to set up an account with us. You can do this &nbsp;
                  ...
                  <li>
                    ...
                    you choose, or you are provided with, a user identification
                  ...
                  <li>
                    <strong>We may disable your account.</strong> We have the
                  ...
                  <li>
                    <strong>Direct debit payments.</strong> You agree to set up
                    a direct debit payment with us to make the payments you have
                    agreed to pay to us under this agreement.
                  </li>
                </ul>
              </li>
              <li>
              ...
              <li>
                ...
                <ul>
                  <li>
                    ...
                    may obtain from them. We have no control over the contents
              ...
              <li>
                ...
                <ul>
                  <li>
                    ...
                    . We may terminate or suspend (at our absolute discretion
                    and not limiting any other remedies that we may have) your
                    use of the site at any time by writing to you if:
                    <ul>
                      <li>
                        you do not make any payment to us when it is due and you
                        still do not make payment within 7 days of us reminding
                        you that payment is due;
                      </li>
                      <li>
                        we believe that you have used the site in breach of
                        clause 7 (Information on our site), clause 8 (User
                        Content and Reviews), or clause 9 (Links to and from
                        other websites); or
                      </li>
                      <li>
                        we believe that you have breached any other material
              ...
              <li>
                ...
                <ul>
                  <li>
                    ...
                    terms. We are not responsible for any loss or damage that is
                    not foreseeable. Loss or damage is foreseeable if either it
                    is obvious that it will happen or if, at the time the
                  ...
                  <li>
                    ...
                    caused by our negligence or the negligence of our employees,
                    agents or subcontractors; for fraud or fraudulent
                  ...
                  <li>
                    <strong>We are not liable for business losses</strong>. If
                    you are a consumer please note that we only provide our site
                    for domestic and private use. You agree not to use our site
                    for any commercial or business purposes. If you do use our
                    site for any commercial, business or re-sale purpose our
                    liability to you will be limited as set out in clause 4.
                  </li>
                  <li>
                    <strong>
              ...
              <li>
                ...
                <ul>
                  <li>
                    ...
                    be in breach of any contract or be liable for any failure to
                    perform, or delay in performance of, any of our obligations
                    under these terms that is caused by events or circumstances
                    outside our reasonable control.
                  </li>
                  <li>
                    <strong>How we will use your personal information</strong>.
                  ...
                  <li>
                    ...
                    terms to another organisation without your consent.
                  </li>
                  <li>
                    <strong>
                    ...
                    under these terms to another person if we agree to this in
                    writing.
                  </li>
                  <li>
                    <strong>
                    ...
                    . These terms and any other terms expressly referred to in
                    them constitute the whole agreement between you and us and
                    supersede all previous discussions, correspondence,
                    negotiations, previous agreement, understanding or agreement
                  ...
                  <li>
                    ...
                    . Each of the clauses of these terms operates separately. If
                    any court or relevant authority decides that any of them are
                    unlawful, the remaining clauses will remain in full force
                    and effect.
                  </li>
                  <li>
                    <strong>
                    ...
                    . If we do not insist immediately that you do anything you
                    are required to do under these terms, or if we delay in
                    taking steps against you in respect of your breaking these
                    terms, that will not mean that you do not have to do those
                    things and it will not prevent us taking steps against you
                    at a later date. For example, if you miss a payment and we
                    do not chase you but we continue to provide the products, we
