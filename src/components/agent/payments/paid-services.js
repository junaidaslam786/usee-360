            ...
            <Col>
              <Card>
                <Card.Body>
                  ...
                  <Card.Text>
                    {/* Monthly Free Units: {service.remainingFreeUnits} */}
                    Monthly Free Units: 10
                  </Card.Text>
                  <Card.Text>
                  ...
                  <Form>
                    <Row className="align-items-center">
                      ...
                      <Col xs={6} md={3}>
                        <p>Price per Token: {service.tokenPrice}</p>
                        <p>
                          Total Tokens: {service.tokenPrice * service.quantity}
                        </p>
                      </Col>
                    </Row>
                  </Form>
