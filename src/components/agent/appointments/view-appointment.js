...
export default function View(props) {
  const [appointmentView, setAppointmentView] = useStateIfMounted({});
  ...
  useEffect(() => {
    if (props.appointment) {
      const appointmentViewDetail = {
        ...
        allotedAgentName: props.appointment?.allotedAgentUser
          ? `${props.appointment.allotedAgentUser.firstName} ${props.appointment.allotedAgentUser.lastName}`
          : null,
                  ...
                  <div className="row">
                    ...
                    <div className="col-lg-6">
                      <div>
                        ...
                        <p className="p-0 m-o">
                          {appointmentView.allotedAgentName
                            ? appointmentView.allotedAgentName
