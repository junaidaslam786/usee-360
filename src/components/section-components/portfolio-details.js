              ...
              <aside className="sidebar-area ltn__right-sidebar">
                ...
                <div className="widget-2 ltn__menu-widget ltn__menu-widget-2 text-uppercase">
                  <ul className="go-top">
                    <li>
                      <Link to="/portfolio">
                  Property Management<span><i className="fas fa-arrow-right" /></span>
                </Link>
                    </li>
                    <li className="active">
                      <Link to="/portfolio">
                  Mortgage Service<span><i className="fas fa-arrow-right" /></span>
                </Link>
                    </li>
                    <li>
                      <Link to="/portfolio">
                  Consulting Service<span><i className="fas fa-arrow-right" /></span>
                </Link>
                    </li>
                    <li>
                      <Link to="/portfolio">
                  Home Buying<span><i className="fas fa-arrow-right" /></span>
                </Link>
                    </li>
                    <li>
                      <Link to="/portfolio">
                  Home Selling<span><i className="fas fa-arrow-right" /></span>
                </Link>
                    </li>
                    <li>
                      <Link to="/portfolio">
                  Escrow Services<span><i className="fas fa-arrow-right" /></span>
                </Link>
                    </li>
                  </ul>
                </div>
