            ...
            <div className="col-xl-4 col-md-4 col-sm-6 col-6">
              <div className="ltn__category-item ltn__category-item-5 text-center">
                ...
                >
                  ...
                  <p>Use our video call facility.</p>
                </Link>
              </div>
            </div>
            <div className="col-xl-4 col-md-4 col-sm-6 col-6">
              <div className="ltn__category-item ltn__category-item-5 text-center">
                ...
                >
                  ...
                  <p>Upload your own virtual tours.</p>
                </Link>
              </div>
            </div>
            <div className="col-xl-4 col-md-4 col-sm-6 col-6">
              <div className="ltn__category-item ltn__category-item-5 text-center">
                ...
                >
                  ...
                  <p>Deliver multiple properties in one viewing.</p>
                </Link>
              </div>
            </div>
            <div className="col-xl-4 col-md-4 col-sm-6 col-6">
              <div className="ltn__category-item ltn__category-item-5 text-center">
                ...
                >
                  ...
                  <p>Upload floor plans, brochures and more.</p>
                </Link>
              </div>
            </div>
            <div className="col-xl-4 col-md-4 col-sm-6 col-6">
              <div className="ltn__category-item ltn__category-item-5 text-center">
                ...
                >
                  ...
                  <p>Share your local knowledge.</p>
                </Link>
              </div>
            </div>
            <div className="col-xl-4 col-md-4 col-sm-6 col-6">
              <div className="ltn__category-item ltn__category-item-5 text-center">
                ...
                >
                  ...
                  <p>Data to understand your customers.</p>
                </Link>
              </div>
            </div>
          </div>
