...
class ComingSoon extends Component {
  ...
  render() {
    ...
    return (
      <div className="ltn__coming-soon-area section-bg-2 text-color-white bg-overlay-theme-black-90 bg-image" data-bs-bg={`${publicUrl}assets/img/slider/62.jpg`}>
