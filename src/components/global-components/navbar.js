                        ...
                        <div className="row">
                            <div className="col">
                                <div className="site-logo-wrap">
                                    <div className="site-logo go-top">
                                        <Link to="/">
                                            <img src={`${publicUrl}assets/img/logo.png`} alt="Logo" height="80" />
                                        </Link>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div className="ltn__main-menu go-top">
                                            <ul>
                                                ...
                                                <li className="menu-icon">
                                                    ...
                                                    <div className="separator" style={{ marginLeft: "20px" }}></div>
                                                </li>
                                                <li>
                            ...
                            <div className="col ltn__header-options ltn__header-options-2 mb-sm-20">
                                ...
                                <div className="ltn__drop-menu user-menu">
                                    <ul>
                                        <li className={!location.pathname.includes("customer") ? "button-inactive" : null}>
