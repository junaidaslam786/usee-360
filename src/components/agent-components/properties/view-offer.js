...
export default function ViewOffer(props) {
    ...
    const updateOfferStatus = async (formData) => {
        ...
        const formResponse = await axios
            .post(`${process.env.REACT_APP_API_URL}/property/agent/update-offer`, formData, {
                headers: {
    ...
    const handleSnagListFormSubmit = async (e) => {
        ...
        const formResponse = await axios
            .post(
                `${process.env.REACT_APP_API_URL}/property/agent/snag-list`,
                {
                    offerId: snagOfferId,
                                    ...
                                    <td>
                                        {element?.status === OFFER_STATUS.PENDING && (
                                            <div>
                                                ...
                                                <button className="rejectBtn" data-bs-toggle="modal" data-bs-target="#ltn_offer_status_modal" onClick={() => handleRejectOfferButtonClick(element.id)}>
                                                    Reject
                                                </button>
                                            </div>
                                        )}
                                        {element?.status === OFFER_STATUS.ACCEPTED && (
                                            <button data-bs-toggle="modal" data-bs-target="#ltn_snag_list_modal" onClick={() => handleSnagListButtonClick(element.id)}>
                                                Snag List
                                            </button>
                                        )}
                                    </td>
                        ...
                        <div className="modal-dialog modal-md" role="document">
                            <div className="modal-content">
                                <div className="modal-header">
                                    <button type="button" className="close" data-bs-dismiss="modal" ref={closeModal} aria-label="Close">
                                            ...
                                            <div className="row">
                                                <div className="col-12">
                                                    <div className="modal-product-info text-center">
                                                        ...
                                                        <form className="ltn__form-box" onSubmit={rejectOfferHandler}>
                                                            <textarea placeholder="Reason to reject offer" value={offerRejectReason} onChange={(e) => setOfferRejectReason(e.target.value)} />
                                                                                ...
                                                                                SNAG_LIST.map((element, index) =>
                                                                                    isApprovedByAgent && isApprovedByCustomer ? (
                                                                                        <tr key={index}>
                                                                                            ...
                                                                                            <td>{snagListFormData[index]?.customerComment ? snagListFormData[index].customerComment : "N/A"}</td>
                                                                                        </tr>
                                                                                    ) : (
                                                                                        <tr key={index}>
                                                                                            <td>
                                                                        ...
                                                                        <div className="row mb-50">
                                                                            <div className="col-md-12">
                                                                                <div className="input-item">
                                                                                    ...
                                                                                    <div className="input-item">
                                                                                        <input type="checkbox" checked={agentApprove} onChange={agentApproveCheckHandler} />
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        </div>
