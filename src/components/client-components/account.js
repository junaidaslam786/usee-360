            ...
            <div className="col-lg-12">
              ...
              <div className="ltn__product-tab-area">
                <div className="container">
                  ...
                  ?<small><a href="login.html">Log out</a></small>
                  {' '}
                  )
</p>
                  <p>
                  From your account dashboard you can view your<span>recent orders</span>
                  , manage your<span>shipping and billing addresses</span>
                  , and<span>edit your password and account details</span>
                  .
</p>
                </div>
                </div>
                  ...
                  <h4>
                  Billing Address<small><Link to="#">edit</Link></small>
                </h4>
                  <address>
                  ...
                  <div className="col-md-6 col-12 learts-mb-30">
                  <h4>
                  Shipping Address<small><Link to="#">edit</Link></small>
                </h4>
                  <address>
                  <p><strong>Alex Tuntuni</strong></p>
                  <p>
                  ...
                  <h5>
                  Returning customer?<a className="ltn__secondary-color" href="#ltn__returning-customer-login" data-toggle="collapse">Click here to login</a>
                </h5>
                  ...
                  <h5>
                  Have a coupon?<a className="ltn__secondary-color" href="#ltn__coupon-code" data-toggle="collapse">Click here to enter your code</a>
                </h5>
